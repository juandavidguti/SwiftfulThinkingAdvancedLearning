...
// subscripts are not very common, we can custom actions per values but not to be used in production apps.
...
//            selectedItem = myArray.first(where: { string in
//                string == value
//            })
//            selectedItem = myArray["three"]
            
            let customer = Customer(name: "juan", address: Address(street: "Main Street", city: City(name: "New York", state: "NY")))
...
//            selectedItem = myArray[0] // This is called a subscript. we can
